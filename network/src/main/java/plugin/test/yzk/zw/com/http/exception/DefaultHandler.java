...
public class DefaultHandler implements EHandler {
    ...
    public void handleException(Throwable e) {
        if (e instanceof CustomException) {
            ...
            exception = new CustomException(httpException.code(), context.getResources().getString(R.string.network_error));
        } else if (e instanceof JsonParseException || e instanceof JSONException || e instanceof ParseException) {
            exception = new CustomException(CustomException.PARSE_ERROR, context.getResources().getString(R.string.parse_error));
        } else if (e instanceof ConnectException) {
            exception = new CustomException(CustomException.CONNECT_ERROR, context.getResources().getString(R.string.connect_error));
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            exception = new CustomException(CustomException.SSLHANDSHAKE_ERROR, context.getResources().getString(R.string.ssl_error));
        } else {
            exception = new CustomException(CustomException.UNKNOWN_ERROR, context.getResources().getString(R.string.unknown_error));
        }
